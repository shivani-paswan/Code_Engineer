...
class RegisterNowBkp extends StatefulWidget {
  const RegisterNowBkp({Key? key}) : super(key: key);

  @override
  State<RegisterNowBkp> createState() => _RegisterNowBkpState();
}

class _RegisterNowBkpState extends State<RegisterNowBkp> {
  bool loading = false;
