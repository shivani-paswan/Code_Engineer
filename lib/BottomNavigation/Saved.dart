  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Saved Playlist',style: TextStyle(color: Colors.white),),
...
class ReusableTile extends StatelessWidget {
  ...
  ReusableTile({Key? key,required this.title,required this.subtitle,required this.trailingImage,required this.moreTab,required this.close}) : super(key: key);
