    ...
    return Scaffold(
      ...
      appBar: AppBar(
       backgroundColor: Colors.black,
        leading: IconButton(
          icon: Image.asset("assets/images/menu.png",height:25,color:  Colors.white),
          onPressed: (){
...
SizedBox(width: 20,),
                            Text('𝕔𝕠𝕕𝕖 𝕖𝕟𝕘𝕚𝕟𝕖𝕖𝕣',style: TextStyle(fontSize: 16,color: Colors.white),)
                          ],
                        ),
                ),
              ),
            ...
            ListTile(
              leading: Container(
                  ...
                  child: Image.asset("assets/images/user.png",height:25,color: Colors.white,)),

              title: Text('𝐏𝐫𝐨𝐟𝐢𝐥𝐞',style:TextStyle(color: Colors.white),),
              onTap: (){
            ...
            ListTile(
              leading: Container(
                  ...
                  decoration: BoxDecoration(
                      color: Color.fromRGBO(128, 128, 128, 0.4),
                      borderRadius: BorderRadius.all(Radius.circular(10))),
                  child: Image.asset("assets/images/img_1.png",height:30,color: Colors.white,)),

              title: Text('𝐆𝐮𝐢𝐝𝐞𝐬',style:TextStyle(color: Colors.white),),
              onTap: (){
                Navigator.pop(context);
              },
            ),
            ...
            ListTile(
              leading: Container(
                  ...
                  decoration: BoxDecoration(
                      color: Color.fromRGBO(128, 128, 128, 0.4),
                      borderRadius: BorderRadius.all(Radius.circular(10))),
                  child: Image.asset("assets/images/help.png",height:30,color: Colors.white,)),

              title: Text('𝐇𝐞𝐥𝐩 & 𝐒𝐮𝐩𝐩𝐨𝐫𝐭',style:TextStyle(color: Colors.white),),
              onTap: (){
                Navigator.pop(context);
              },
            ),
            ...
            ListTile(
              leading: Container(
                  ...
                  decoration: BoxDecoration(
                      color: Color.fromRGBO(128, 128, 128, 0.4),
                      borderRadius: BorderRadius.all(Radius.circular(10))),
                  child: Image.asset("assets/images/settings.png",height:30,color: Colors.white,)),

              title: Text('𝐏𝐥𝐚𝐲𝐥𝐢𝐬𝐭 𝐒𝐞𝐭𝐭𝐢𝐧𝐠𝐬',style:TextStyle(color: Colors.white),),
              onTap: (){
                Navigator.pop(context);
              },
            ),
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                  Text('Code Masters',style: TextStyle(color:Colors.white,fontWeight: FontWeight.bold,fontSize: 18),),
                  Container(
                ...
                Align(
                    ...
                    child: Text('Available Notes',style: TextStyle(color:Colors.white,fontWeight: FontWeight.bold,fontSize: 18),)),
SizedBox(height: 10,),
